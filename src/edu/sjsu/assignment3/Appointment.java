...
public abstract class Appointment implements Comparable<Appointment> {
    ...
    public int compareTo(Appointment appointment) {
        if(this.startDate.equals(appointment.startDate)) {
            if(this.endDate.equals(appointment.endDate)) {
                if(this.description.equals(appointment.description)) {
                    return 0;
                }
                return this.description.compareTo(appointment.description);
            }
            return this.endDate.compareTo(appointment.endDate);
        }
