...
class OnetimeAppointmentTest{
    ...
    void testOccursOn() {
        ...
        Assertions.assertTrue(appointment.occursOn(testDate1)); // returns true
        Assertions.assertFalse(appointment.occursOn(testDate2)); // returns false (not the same date)
